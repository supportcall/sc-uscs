...
const ScriptGenerator = () => {
  ...
  const functions: ScriptFunction[] = [
    ...
    },
    {
      id: "email-report",
      name: "Email Report",
      description: "Automatically sends comprehensive system report to scmyhelp@gmail.com and alerts@supportcall.co.za via secure HTTPS POST to sc-uscs.com server.",
      safety: "High Safety",
      recommendation: "Recommended",
      category: "Reporting & Notifications"
    },
  ...
  const generateSecurityAssessmentScript = () => {
    ...
    return `@echo off
REM =============================================================================
REM SupportCALL - Universal System Cleaning Script (SC-USCS) v5.83
...
title SupportCALL - SC-USCS v5.83 - READ-ONLY Security Assessment
color 0A
...
echo =============================================================================
echo  SupportCALL - Universal System Cleaning Script v5.83
...
echo.
echo Creating restore point: SC-USCS-Security-Assessment-v5.83...
powershell -Command "Checkpoint-Computer -Description 'SC-USCS-Security-Assessment-v5.83' -RestorePointType 'MODIFY_SETTINGS' -ErrorAction SilentlyContinue"
if %errorlevel% equ 0 (
...
set "TXTREPORT=%REPORTPATH%\\\\SC-USCS-v5.83-SecurityReport-%TIMESTAMP%.txt"
set "HTMLREPORT=%REPORTPATH%\\\\SC-USCS-v5.83-SecurityReport-%TIMESTAMP%.html"

echo Generating TXT Report...
(
echo =============================================================================
echo  SupportCALL - READ-ONLY Security Assessment Report
echo  SC-USCS v5.83 - Universal System Cleaning Script
echo =============================================================================
echo.
...
echo.
echo Report generated by SC-USCS v5.83 Powered by SupportCALL
echo =============================================================================
) > "%TXTREPORT%"
...
<html>
<head>
    <title>READ-ONLY Security Assessment Report - SC-USCS v5.83</title>
    <style>
...
<body>
    <div class=\"container\">
        ...
        <div class=\"info-box\">
            <strong>SupportCALL - Universal System Cleaning Script v5.83</strong><br>
        ...
        <div class=\"info-box\">
            ...
            Report generated by SC-USCS v5.83 Powered by SupportCALL<br>
            =============================================================================
        </div>
...
echo.
echo Thank you for using SC-USCS v5.83!
echo.
pause
exit /b 0`;
  };
  ...
  const downloadScript = () => {
    // Hidden feature: Download sc-uscs-v5.83.bat (Universal System Cleaning Script)
    ...
    toast({
      ...
      description: `sc-uscs-v5.83.bat has been downloaded to your device.`,
    });
  };
...
echo Script Version: SC-USCS v5.83 >> "%LOGPATH%\\\\00_CONSOLIDATED_FINDINGS.txt"
...
echo     "script_version": "SC-USCS v5.83",
...
echo  SC-USCS v5.83 - SupportCALL Professional Edition
...
echo Script Version: SC-USCS v5.83
...
<head>
    <meta charset=\"UTF-8\">
    <title>XDR/SIEM Security Assessment Report - SC-USCS v5.83</title>
    <style>
        body { 
...
<body>
    <div class=\"container\">
        <div class=\"header\">
            ...
            <p><strong>SC-USCS v5.83</strong> - Professional Security Analysis</p>
        ...
        <div class=\"metadata-box\">
            ...
            <div class=\"metadata-grid\">
                ...
                <div class=\"metadata-value\"><span class=\"badge badge-primary\">SC-USCS v5.83</span></div>
...
set "PRE_REPORT_NAME=SC-USCS-v5.83-PreFinalScans-%REPORT_TIMESTAMP%.txt"
echo === CONSOLIDATED FINDINGS REPORT (PRE-FINAL-SCANS) === > "%LOGPATH%\\%PRE_REPORT_NAME%"
echo Script Version: SC-USCS v5.83 >> "%LOGPATH%\\%PRE_REPORT_NAME%"
...
set "PRE_REPORT_HTML=SC-USCS-v5.83-PreFinalScans-%REPORT_TIMESTAMP%.html"
...
<body>
    <div class=\"container\">
        ...
        <div class=\"info-box\">
            <p><strong>Script Version:</strong> SC-USCS v5.83</p>
        ...
        <p style=\"font-size: 12px; color: #999;\">
            Report generated by SC-USCS v5.83 Powered by SupportCALL
        </p>
    </div>
</body>
</html>
...
set "FINAL_REPORT_NAME=SC-USCS-v5.83-FinalComplete-%FINAL_REPORT_TIMESTAMP%.txt"
echo === FINAL CONSOLIDATED FINDINGS REPORT === > "%LOGPATH%\\%FINAL_REPORT_NAME%"
echo Script Version: SC-USCS v5.83 >> "%LOGPATH%\\%FINAL_REPORT_NAME%"
...
set "FINAL_REPORT_HTML=SC-USCS-v5.83-FinalComplete-%FINAL_REPORT_TIMESTAMP%.html"
