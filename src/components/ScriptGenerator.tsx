...
const ScriptGenerator = () => {
  ...
  const generateSecurityAssessmentScript = () => {
    ...
    return `@echo off
REM =============================================================================
REM SupportCALL - Universal System Cleaning Script (SC-USCS) v5.82
...
title SupportCALL - SC-USCS v5.82 - READ-ONLY Security Assessment
color 0A
...
echo =============================================================================
echo  SupportCALL - Universal System Cleaning Script v5.82
...
echo.
echo Creating restore point: SC-USCS-Security-Assessment-v5.82...
powershell -Command "Checkpoint-Computer -Description 'SC-USCS-Security-Assessment-v5.82' -RestorePointType 'MODIFY_SETTINGS' -ErrorAction SilentlyContinue"
if %errorlevel% equ 0 (
...
set "TXTREPORT=%REPORTPATH%\\\\SC-USCS-v5.82-SecurityReport-%TIMESTAMP%.txt"
set "HTMLREPORT=%REPORTPATH%\\\\SC-USCS-v5.82-SecurityReport-%TIMESTAMP%.html"

echo Generating TXT Report...
(
echo =============================================================================
echo  SupportCALL - READ-ONLY Security Assessment Report
echo  SC-USCS v5.82 - Universal System Cleaning Script
echo =============================================================================
echo.
...
echo.
echo Report generated by SC-USCS v5.82 ^(READ-ONLY Assessment Mode^)
echo =============================================================================
) > "%TXTREPORT%"
...
<html>
<head>
    <title>READ-ONLY Security Assessment Report - SC-USCS v5.82</title>
    <style>
...
<body>
    <div class=\"container\">
        ...
        <div class=\"info-box\">
            <strong>SupportCALL - Universal System Cleaning Script v5.82</strong><br>
        ...
        <div class=\"footer\">
            Report generated by SC-USCS v5.82 - SupportCALL Universal System Cleaning Script<br>
...
echo.
echo Thank you for using SC-USCS v5.82!
echo.
pause
exit /b 0`;
  };
...
echo Script Version: SC-USCS v5.82 >> "%LOGPATH%\\\\00_CONSOLIDATED_FINDINGS.txt"
...
echo     "script_version": "SC-USCS v5.82",
...
echo  SC-USCS v5.82 - SupportCALL Professional Edition
...
echo Script Version: SC-USCS v5.82
...
<head>
    <meta charset=\"UTF-8\">
    <title>XDR/SIEM Security Assessment Report - SC-USCS v5.82</title>
    <style>
        body { 
...
<body>
    <div class=\"container\">
        <div class=\"header\">
            ...
            <p><strong>SC-USCS v5.82</strong> - Professional Security Analysis</p>
        ...
        <div class=\"metadata-box\">
            ...
            <div class=\"metadata-grid\">
                ...
                <div class=\"metadata-value\"><span class=\"badge badge-primary\">SC-USCS v5.82</span></div>
        ...
        <div class=\"footer\">
            ...
            <p style=\"font-size: 12px; color: #999;\">
                This report was automatically generated by SC-USCS v5.82<br>
...
<body>
    <div class='container'>
        <div class='header'>
            ...
            <p>Windows Remediation & Security Scan v5.82</p>
        </div>
        <div class='content'>
...
set "PRE_REPORT_NAME=SC-USCS-v5.82-PreFinalScans-%REPORT_TIMESTAMP%.txt"
echo === CONSOLIDATED FINDINGS REPORT (PRE-FINAL-SCANS) === > "%LOGPATH%\\%PRE_REPORT_NAME%"
echo Script Version: SC-USCS v5.82 >> "%LOGPATH%\\%PRE_REPORT_NAME%"
...
set "PRE_REPORT_HTML=SC-USCS-v5.82-PreFinalScans-%REPORT_TIMESTAMP%.html"
...
<body>
    <div class=\"container\">
        ...
        <div class=\"info-box\">
            <p><strong>Script Version:</strong> SC-USCS v5.82</p>
...
set "FINAL_REPORT_NAME=SC-USCS-v5.82-FinalComplete-%FINAL_REPORT_TIMESTAMP%.txt"
echo === FINAL CONSOLIDATED FINDINGS REPORT === > "%LOGPATH%\\%FINAL_REPORT_NAME%"
echo Script Version: SC-USCS v5.82 >> "%LOGPATH%\\%FINAL_REPORT_NAME%"
...
set "FINAL_REPORT_HTML=SC-USCS-v5.82-FinalComplete-%FINAL_REPORT_TIMESTAMP%.html"
...
` : '';
    ...
    return `@echo off
REM =============================================================================
REM SupportCALL - Ultimate Secure Clean Script (SC-USCS) v5.82
...
setlocal EnableDelayedExpansion
title SupportCALL - SC-USCS v5.82 - Professional Edition
...
echo =============================================================================
echo  SupportCALL - Ultimate Secure Clean Script v5.82
...
echo Script: SC-USCS v5.82 >> "%LOGPATH%\\\\execution-timeline.log"
...
echo SC-USCS v5.82 - Execution Progress Tracker >> "%LOGPATH%\\\\progress-summary.txt"
...
echo Creating System Restore Point: SC-USCS-Pre-Run-v5.82...
powershell -Command "$result = Checkpoint-Computer -Description 'SC-USCS-Pre-Run-v5.82' -RestorePointType 'MODIFY_SETTINGS' -Verbose; if ($result -eq $null) { Write-Host 'SUCCESS: System Restore Point Created' -ForegroundColor Green } else { Write-Host 'WARNING: Restore Point Creation Status Unknown' -ForegroundColor Yellow }"
...
echo ✓ Pre-Final Report: %LOGPATH%\\\\SC-USCS-v5.82-PreFinalScans-*.txt
echo ✓ Pre-Final HTML Report: %LOGPATH%\\\\SC-USCS-v5.82-PreFinalScans-*.html
echo ✓ Final Complete Report: %LOGPATH%\\\\SC-USCS-v5.82-FinalComplete-*.txt
echo ✓ Final Complete HTML Report: %LOGPATH%\\\\SC-USCS-v5.82-FinalComplete-*.html
` : ''}
echo.
